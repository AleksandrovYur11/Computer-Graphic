...
ring_lens = RingClass(name = "Ring_Lens", org = (0, 0, 0),  centered = True, radius1 = 10, radius2 = 31)
...
kernel = GetKernel()
kernel.PTRenderNotebook(scene.Notebook(), "real_lens_20.jpg", OverwriteMode.OVERWRITE)

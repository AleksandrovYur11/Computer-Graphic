...
ring_lens = RingClass(name = "Ring_Lens", org = (0, 0, 0),  centered = True, radius1 = 5, radius2 = 31)
...
kernel = GetKernel()
kernel.PTRenderNotebook(scene.Notebook(), "real_lens_10.jpg", OverwriteMode.OVERWRITE)

# IMAPS
imaps = scene.IMapsParams()
imaps.req_acc = 0.01
imaps.time_limit = 5000
